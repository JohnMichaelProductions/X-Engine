...
#include "imgui.h"
#include "Platforms/OpenGL/ImGuiOpenGL3.h"
...
namespace XEngine
{
	...
	{ 
		...
		// If the event matches the event type specified in the <type>
		// then it will call the function in its (function)
		...
		dispatcher.Dispatch<WindowResizeEvent>			(X_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
	}
